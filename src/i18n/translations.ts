...
export const en = {
  ...
  'settings.deleteAccountConfirm': 'This permanently deletes your account and all your data on every device. This cannot be undone.',
...
export const sw: Record<TKey, string> = {
  ...
  'settings.deleteAccountConfirm': 'Hii itafuta kabisa akaunti yako na data yako yote kwenye vifaa vyote. Haiwezi kutenduliwa.',
  'settings.deleteAccountFailed': 'Imeshindwa kufuta akaunti yako. Tafadhali jaribu tena.',
  'settings.deletingAccount': 'Inafuta akaunti…',
